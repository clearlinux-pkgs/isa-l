...
Version  : 2.17.0
Release  : 9
URL      : https://github.com/01org/isa-l/archive/v2.17.0.tar.gz
Source0  : https://github.com/01org/isa-l/archive/v2.17.0.tar.gz
...
%prep
%setup -q -n isa-l-2.17.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1483737339
export AR=gcc-ar
