...
Source0  : https://github.com/intel/isa-l/archive/v2.31.1/isa-l-2.31.1.tar.gz
...
%prep
%setup -q -n isa-l-2.31.1
cd %{_builddir}/isa-l-2.31.1
pushd ..
cp -a isa-l-2.31.1 buildavx2
popd
pushd ..
cp -a isa-l-2.31.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736438119
