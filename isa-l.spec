...
Version  : 2.29.0
Release  : 32
URL      : https://github.com/01org/isa-l/archive/v2.29.0/isa-l-2.29.0.tar.gz
Source0  : https://github.com/01org/isa-l/archive/v2.29.0/isa-l-2.29.0.tar.gz
...
%prep
%setup -q -n isa-l-2.29.0
cd %{_builddir}/isa-l-2.29.0
pushd ..
cp -a isa-l-2.29.0 buildavx2
popd
pushd ..
cp -a isa-l-2.29.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583160784
...
cp %{_builddir}/isa-l-2.29.0/LICENSE %{buildroot}/usr/share/package-licenses/isa-l/c41999097043083c4213a15101a122f1401e41df
pushd ../buildavx512/
%make_install_avx512
popd
pushd ../buildavx2/
...
/usr/lib64/haswell/avx512_1/libisal.so.2.0.29
/usr/lib64/haswell/libisal.so.2
/usr/lib64/haswell/libisal.so.2.0.29
/usr/lib64/libisal.so.2
/usr/lib64/libisal.so.2.0.29
