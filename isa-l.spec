...
Source0  : https://github.com/01org/isa-l/archive/v2.27.0/isa-l-2.27.0.tar.gz
...
%prep
%setup -q -n isa-l-2.27.0
pushd ..
cp -a isa-l-2.27.0 buildavx2
popd
pushd ..
cp -a isa-l-2.27.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562049498
...
/usr/lib64/haswell/avx512_1/libisal.so.2.0.27
/usr/lib64/haswell/libisal.so.2
/usr/lib64/haswell/libisal.so.2.0.27
/usr/lib64/libisal.so.2
/usr/lib64/libisal.so.2.0.27
