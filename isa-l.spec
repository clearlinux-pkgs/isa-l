...
%prep
%setup -q -n isa-l-2.28.0
pushd ..
cp -a isa-l-2.28.0 buildavx2
popd
pushd ..
cp -a isa-l-2.28.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570559748
...
/usr/lib64/haswell/avx512_1/libisal.so.2.0.28
/usr/lib64/haswell/libisal.so.2
/usr/lib64/haswell/libisal.so.2.0.28
/usr/lib64/libisal.so.2
/usr/lib64/libisal.so.2.0.28
